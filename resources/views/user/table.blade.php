<div class="card card-custom gutter-b">
    <div class="card-header flex-wrap py-3">
        <div class="card-title">
            <h3 class="card-label">
                Usuarios
                <span class="d-block text-muted pt-2 font-size-sm">Listado general de los usuarios</span>
            </h3>
        </div>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <div class="btn-group-toggle" data-toggle="buttons">
                                        ...
                                        <a href="{{route('user.edit', $user->id) }}" class="btn btn-icon btn-outline-success btn-shadow font-weight-bold btn-sm" data-toggle="tooltip" data-theme="dark" title="Editar Manual">
