			...
			<div class="d-flex flex-center bgi-size-cover bgi-no-repeat flex-row-fluid" style="background-image: url(metronic/dist/assets/media/bg/bg-2.jpg);">
				<div class="login-form text-center text-white p-7 position-relative overflow-hidden">
					...
					<div class="d-flex flex-center mb-15">
						<a href="#">
							<img src="metronic/dist/assets/media/logos/5.png" width="100px" alt="" class="img-fluid" />
						</a>
					</div>
					...
					<div class="login-signin">
						<div class="mb-20">
							<h3 class="opacity-80 font-weight-normal">Inicia Sesión</h3>
							<p class="opacity-80">Ingresa tu usuario y contraseña</p>
						</div>
